...
void loop() {
  ...
  if(hatChanged){
    ...
    if (numPressed < 1 || numPressed > 2) lastHatAngle = -1;
    ...
    else if(lastHatState[0] == 1 && lastHatState[2] == 1) lastHatAngle = -1;
    else if(lastHatState[1] == 1 && lastHatState[3] == 1) lastHatAngle = -1;
