...
int pinToButton    [NUM_BUTTONS] = { 11,  10,   8,   9,  12,  13,        3,       2,   0,     1};
...
int pinToHat    [NUM_HAT_BUTTONS] = {   4,       7,      6,      5};
...
int pinToAnalog    [NUM_ANALOG] = {            A0,             A1,              A2,              A3,   A4,   A5};
...
int pinRange[NUM_ANALOG][2] = {{STICK_MIN, STICK_MAX}, {STICK_MIN, STICK_MAX}, {STICK_MIN, STICK_MAX}, {STICK_MIN, STICK_MAX}, {POT_MIN, POT_MAX}, {POT_MIN, POT_MAX}};
